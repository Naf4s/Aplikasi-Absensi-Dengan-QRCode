...
import { 
  X, LayoutDashboard, Users, QrCode, 
  BarChart2, Settings, LogOut, BookOpen, GraduationCap, CalendarCheck, FileText, 
  Send
...
const DashboardSidebar: React.FC<DashboardSidebarProps> = ({ isOpen, onClose }) => {
  const { user, logout, hasPermission } = useAuth(); // Use real auth context
