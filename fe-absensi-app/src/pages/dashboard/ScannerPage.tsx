...
const ScannerPage: React.FC = () => {
  ...
  const onScanSuccess = async (decodedText: string) => {
    ...
    try {
      ...
      const result: ScanResult = {
        id: (qrDataParsed && qrDataParsed.id) || 'error',
        name: (qrDataParsed && qrDataParsed.name) || 'Tidak Dikenal',
        class: (qrDataParsed && qrDataParsed.class) || '-',
        timestamp: new Date(),
        success: false,
        message: msg,
      };
        ...
        <div className="lg:col-span-2">
          <div className="card p-5">
            ...
            <div 
                ref={scannerDivRef} 
                id="qr-reader" 
                className={`max-w-full ${!scanning ? 'hidden' : ''}`} // HIDE with Tailwind if not scanning
            ></div>
