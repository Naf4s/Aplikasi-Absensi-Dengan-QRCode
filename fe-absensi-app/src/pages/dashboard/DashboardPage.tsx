...
const DashboardPage: React.FC = () => {
  ...
  const totalMarkedToday = dashboardData?.attendanceStatsToday.presentCount +
                          dashboardData?.attendanceStatsToday.absentCount +
                          dashboardData?.attendanceStatsToday.sickCount +
                          dashboardData?.attendanceStatsToday.permitCount;
  ...
  const presentPercentage = getPercentage(dashboardData?.attendanceStatsToday.presentCount || 0);
        ...
        <div className="card p-5">
          <div className="flex items-start">
            ...
            <div className="ml-4">
              ...
              <p className="mt-1 text-2xl font-semibold text-gray-900">{dashboardData.attendanceStatsToday.presencePercentage}%</p>
            </div>
          </div>
        </div>
          ...
          <div className="flex items-start">
            ...
            <div className="ml-4">
              ...
              <p className="mt-1 text-xl font-semibold text-gray-900">
                {dashboardData.attendanceStatsToday.uniquePresentStudentsToday} hadir dari {dashboardData.totalStudents} siswa
              </p>
            </div>
          </div>
        </div>
        ...
        <div className="card p-5">
          ...
          <div className="space-y-4">
            ...
            <div>
              ...
              <div className="w-full bg-gray-200 rounded-full h-2">
                <div className="bg-accent-500 h-2 rounded-full" style={{ width: `${permitPercentage}%` }}></div>
              </div>
            </div>
            ...
            <div>
              ...
              <div className="w-full bg-gray-200 rounded-full h-2">
                <div className="bg-warning-500 h-2 rounded-full" style={{ width: `${sickPercentage}%` }}></div>
              </div>
            </div>
