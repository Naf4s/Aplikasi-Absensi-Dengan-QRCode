...
export const getClasses = async (req, res) => {
  try {
    ...
    // Untuk saat ini, hanya admin yang bisa melihat semua kelas.
    // Jika nanti ada role teacher homeroom yang bisa lihat kelasnya saja, logic ditambah di sini.
    if (req.user.role !== 'admin') {
      return res.status(403).json({ message: 'Akses ditolak. Hanya admin yang bisa melihat daftar kelas.' });
    }
