...
export const getAttendanceRecords = async (filters) => {
  ...
  // Ini Wajib Kamu Ingat! (Filter Bulan & Tahun di SQL)
  // Gunakan fungsi STRFTIME untuk mengekstrak bulan dan tahun dari kolom 'date'.
  if (filters.month) {
  ...
  query += ' ORDER BY ar.date DESC, ar.created_at DESC'; // Urutkan berdasarkan tanggal terbaru
